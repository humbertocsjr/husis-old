__videotextoVGA:
    ...
    mov cx, 80*50*2+ObjVideoTexto._Tam
    cs call far [Memoria.AlocaRemoto]
    jnc .fim
    es mov word [ObjVideoTexto.Largura],80
    es mov word [ObjVideoTexto.Altura],50
    ...
    es mov word [ObjVideoTexto.PtrAtualiza], _videotextoAtualizaVGA
